...
class Cobranca(object):
    ...
    def __init__(self, devedor=None, valor=None, chave=None, calendario=None, txid=None, info_adicionais=None, location=None, revisao=None, solicitacao_pagador=None, pix=None, status=None):  # noqa: E501
        """Cobranca - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def devedor(self):
        """Gets the devedor of this Cobranca.  # noqa: E501


        :return: The devedor of this Cobranca.  # noqa: E501
    ...
    def devedor(self, devedor):
        """Sets the devedor of this Cobranca.


        :param devedor: The devedor of this Cobranca.  # noqa: E501
    ...
    @property
    def valor(self):
        """Gets the valor of this Cobranca.  # noqa: E501


        :return: The valor of this Cobranca.  # noqa: E501
    ...
    def valor(self, valor):
        """Sets the valor of this Cobranca.


        :param valor: The valor of this Cobranca.  # noqa: E501
        :type: CobrancasValor
        """
        if valor is None:
    ...
    @property
    def chave(self):
        """Gets the chave of this Cobranca.  # noqa: E501

        Chave Pix do Sistema DICT - BACEN  # noqa: E501

        :return: The chave of this Cobranca.  # noqa: E501
        :rtype: str
        """
        return self._chave
    ...
    def chave(self, chave):
        """Sets the chave of this Cobranca.

        Chave Pix do Sistema DICT - BACEN  # noqa: E501

        :param chave: The chave of this Cobranca.  # noqa: E501
        :type: str
        """
        if chave is None:
    ...
    @property
    def calendario(self):
        """Gets the calendario of this Cobranca.  # noqa: E501


        :return: The calendario of this Cobranca.  # noqa: E501
    ...
    def calendario(self, calendario):
        """Sets the calendario of this Cobranca.


        :param calendario: The calendario of this Cobranca.  # noqa: E501
    ...
    @property
    def txid(self):
        """Gets the txid of this Cobranca.  # noqa: E501
        ...
        :return: The txid of this Cobranca.  # noqa: E501
        :rtype: str
        """
        return self._txid
    ...
    @txid.setter
    def txid(self, txid):
        """Sets the txid of this Cobranca.

        ID de identificação do documento entre os bancos e o cliente emissor.O campo txid é obrigatório e determina o identificador da transação.O objetivo desse campo é ser um elemento que possibilite a conciliação de pagamentos. O txid é criado exclusivamente pelo usuário recebedor e está sob sua responsabilidade. Deve ser único por CNPJ do recebedor. Apesar de possuir o tamanho de 35 posições (PAC008), para QR Code Estático o tamanho máximo permitido é de 25 posições (limitação EMV). No caso do QR Code dinâmico o campo deve possuir de 26 posição até 35 posições. Os caracteres permitidos no contexto do Pix para o campo txId são:Letras minúsculas, de ‘a’ a ‘z’, Letras maiúsculas, de ‘A’ a ‘Z’, Dígitos decimais, de ‘0’ a ‘9’  # noqa: E501

        :param txid: The txid of this Cobranca.  # noqa: E501
        :type: str
        """
        if txid is None:
    ...
    def info_adicionais(self, info_adicionais):
        """Sets the info_adicionais of this Cobranca.

        Cada respectiva informação adicional contida na lista (nome e valor) deve ser apresentada ao pagador  # noqa: E501

        :param info_adicionais: The info_adicionais of this Cobranca.  # noqa: E501
    ...
    @property
    def location(self):
        """Gets the location of this Cobranca.  # noqa: E501

        URL com a Localização do Payload informado na criação da cobrança  # noqa: E501

        :return: The location of this Cobranca.  # noqa: E501
        :rtype: str
        """
    ...
    def location(self, location):
        """Sets the location of this Cobranca.

        URL com a Localização do Payload informado na criação da cobrança  # noqa: E501

        :param location: The location of this Cobranca.  # noqa: E501
        :type: str
        """
        if location is None:
    ...
    @property
    def revisao(self):
        """Gets the revisao of this Cobranca.  # noqa: E501

        Quantidade de revisões da cobrança  # noqa: E501

        :return: The revisao of this Cobranca.  # noqa: E501
        :rtype: float
        """
    ...
    def revisao(self, revisao):
        """Sets the revisao of this Cobranca.

        Quantidade de revisões da cobrança  # noqa: E501

        :param revisao: The revisao of this Cobranca.  # noqa: E501
        :type: float
        """
        if revisao is None:
    ...
    def solicitacao_pagador(self):
        """Gets the solicitacao_pagador of this Cobranca.  # noqa: E501
        ...
        :return: The solicitacao_pagador of this Cobranca.  # noqa: E501
        :rtype: str
        """
    ...
    def solicitacao_pagador(self, solicitacao_pagador):
        """Sets the solicitacao_pagador of this Cobranca.

        O campo solicitacaoPagador, determina um texto a ser apresentado ao pagador para que ele possa digitar uma informação correlata, em formato livre, a ser enviada ao recebedor  # noqa: E501

        :param solicitacao_pagador: The solicitacao_pagador of this Cobranca.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pix(self):
        """Gets the pix of this Cobranca.  # noqa: E501

        Lista de Pix recebidos  # noqa: E501

        :return: The pix of this Cobranca.  # noqa: E501
        :rtype: list[PixsPix]
        """
        return self._pix
    ...
    @pix.setter
    def pix(self, pix):
        """Sets the pix of this Cobranca.

        Lista de Pix recebidos  # noqa: E501

        :param pix: The pix of this Cobranca.  # noqa: E501
        :type: list[PixsPix]
        """
    ...
    def status(self, status):
        """Sets the status of this Cobranca.

        Status da Cobrança. Pode ser: ATIVA, CONCLUIDA, REMOVIDA_PELO_USUARIO_RECEBEDOR, REMOVIDA_PELO_PSP  # noqa: E501

        :param status: The status of this Cobranca.  # noqa: E501
        :type: str
        """
        if status is None:
