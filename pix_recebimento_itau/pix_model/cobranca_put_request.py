...
class CobrancaPutRequest(object):
    ...
    def __init__(self, devedor=None, valor=None, chave=None, calendario=None, info_adicionais=None, solicitacao_pagador=None):  # noqa: E501
        """CobrancaPutRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def devedor(self):
        """Gets the devedor of this CobrancaPutRequest.  # noqa: E501


        :return: The devedor of this CobrancaPutRequest.  # noqa: E501
    ...
    def devedor(self, devedor):
        """Sets the devedor of this CobrancaPutRequest.


        :param devedor: The devedor of this CobrancaPutRequest.  # noqa: E501
    ...
    @property
    def valor(self):
        """Gets the valor of this CobrancaPutRequest.  # noqa: E501


        :return: The valor of this CobrancaPutRequest.  # noqa: E501
    ...
    def valor(self, valor):
        """Sets the valor of this CobrancaPutRequest.


        :param valor: The valor of this CobrancaPutRequest.  # noqa: E501
        :type: CobrancasValor
        """
        if valor is None:
    ...
    @property
    def chave(self):
        """Gets the chave of this CobrancaPutRequest.  # noqa: E501

        Chave Pix do Sistema DICT - BACEN  # noqa: E501

        :return: The chave of this CobrancaPutRequest.  # noqa: E501
        :rtype: str
        """
        return self._chave
    ...
    def chave(self, chave):
        """Sets the chave of this CobrancaPutRequest.

        Chave Pix do Sistema DICT - BACEN  # noqa: E501

        :param chave: The chave of this CobrancaPutRequest.  # noqa: E501
        :type: str
        """
        if chave is None:
    ...
    @property
    def calendario(self):
        """Gets the calendario of this CobrancaPutRequest.  # noqa: E501


        :return: The calendario of this CobrancaPutRequest.  # noqa: E501
    ...
    def calendario(self, calendario):
        """Sets the calendario of this CobrancaPutRequest.


        :param calendario: The calendario of this CobrancaPutRequest.  # noqa: E501
    ...
    def info_adicionais(self):
        """Gets the info_adicionais of this CobrancaPutRequest.  # noqa: E501

        Cada respectiva informação adicional contida na lista (nome e valor) deve ser apresentada ao pagador  # noqa: E501

        :return: The info_adicionais of this CobrancaPutRequest.  # noqa: E501
    ...
    def info_adicionais(self, info_adicionais):
        """Sets the info_adicionais of this CobrancaPutRequest.

        Cada respectiva informação adicional contida na lista (nome e valor) deve ser apresentada ao pagador  # noqa: E501

        :param info_adicionais: The info_adicionais of this CobrancaPutRequest.  # noqa: E501
    ...
    def solicitacao_pagador(self):
        """Gets the solicitacao_pagador of this CobrancaPutRequest.  # noqa: E501
        ...
        :return: The solicitacao_pagador of this CobrancaPutRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def solicitacao_pagador(self, solicitacao_pagador):
        """Sets the solicitacao_pagador of this CobrancaPutRequest.

        O campo solicitacaoPagador, determina um texto a ser apresentado ao pagador para que ele possa digitar uma informação correlata, em formato livre, a ser enviada ao recebedor  # noqa: E501

        :param solicitacao_pagador: The solicitacao_pagador of this CobrancaPutRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CobrancaPutRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CobrancaPutRequest):
            return False
